                ...
                window.requestAnimationFrame(timestamp => {
                    try {
                        ...
                        self.graph_list.forEach(function(graph, key) {
                            ...
                            switch(key) {
                                case "XX.80001.00.001":
                                    graph.seismographConfig.title = 'X-Achse';
                                    graph.seismographConfig.lineColors = ["#ff0000"];
                                    break;
                                //Graph seismographConfig
                                //Höhe des Graphen anpassen
                                case "XX.80001.00.002":
                                    graph.seismographConfig.title = 'Y-Achse';
                                    graph.seismographConfig.lineColors = ["#00ff00"];
                                    break;
                                case "XX.80001.00.003":
                                    graph.seismographConfig.title = 'Z-Achse';
                                    graph.seismographConfig.lineColors = ["#0000ff"];
                                    break;
                            } 
